...
import { copy, getWallpaper, startTimer, stopTimer, storage } from './utils'
...
const createWindow = (): void => {
  ...
  powerMonitor.on('lock-screen', async () => {
    const setting = await store.get('setting-ts')
    const stopWhenLockScreen =
      setting.stopWhenLockScreen ?? DEFAULT_SETTING.startWhenUnlockScreen
